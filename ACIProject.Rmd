...
I start with a k-nearest neighbours model. I'm not sure what value of k to use so I use the cross-validation built into the caret package on the range 15 to 39. I use steps of 4 to reduce the time taken to run the cross-validation. 

```{r knn_selecting_k, message=FALSE, warning=FALSE}
set.seed(3,sample.kind = "Rounding")
#if using R3.5 or earlier set.seed(3)

train_knn <- train(income ~ ., method = "knn", data = training, tuneGrid = data.frame(k = seq(15,39,4)))
